...
/*   Updated: 2016/04/17 12:26:34 by tpaulmye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (int argc, char *argv[])
{
	...
	else			default_modules = "notc";
	std::string::iterator last = unique(default_modules.begin(), default_modules.end());
	if (last != default_modules.end()) default_modules.erase(last, default_modules.end());
